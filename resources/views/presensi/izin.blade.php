                    ...
                    <div class="card-body">
                        <div class="historicontent">
                            <div class="iconpresensi">
                                @if ($d->status == 'i')
                                    <ion-icon name="document-text-outline" style="font-size:48px; color:rgb(21,95,207)">
                                    </ion-icon>
                                @elseif($d->status == 's')
                                    <ion-icon name="medkit-outline"
                                        style="font-size:48px; color:rgb(207, 21, 27)"></ion-icon>
                                @elseif($d->status == 'c')
                                    <ion-icon name="calendar-outline"
                                        style="font-size:48px; color:rgb(19, 113, 35))"></ion-icon>
                                @endif
