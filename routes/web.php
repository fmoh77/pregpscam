...
//Route yang bisa di akses oleh administrator dan admin cabang
Route::group(['middleware' => ['role:administrator|admin cabang,user']], function () {
    ...
    Route::get('/presensi/accizinsakit', [PresensiController::class, 'accizinsakit']);
});

//Route yang bisa di akses oleh administrator
